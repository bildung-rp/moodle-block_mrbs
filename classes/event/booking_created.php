...
/**
 * The block_mrbs_rlp booking created event.
 *
...
class booking_created extends \core\event\base
{
    ...
    {
        return get_string('eventbookingcreated', 'block_mrbs_rlp');
    }
    ...
    {
        global $CFG;
        return array(SITEID, 'mrbs_rlp', 'add booking', $CFG->wwwroot . 'blocks/mrbs_rlp/web/view_entry.php?id=' . $this->objectid,
            $this->other['name']);
    }
