...
$capabilities = [
    ...
    'block/mrbs_rlp:editmrbs_unconfirmed' => [
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => []
    ],
    ...
    'block/mrbs_rlp:ignoremaxadvancedays' => [
        ...
        'clonepermissionsfrom' => 'block/mrbs_rlp:administermrbs',
    ],
];
