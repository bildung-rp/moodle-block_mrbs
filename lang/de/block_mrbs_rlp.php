...
// $Id: block_mrbs_rlp.php,v 1.11 2009/11/07 14:50:34 arborrow Exp $
...
$string['accessmrbs_rlp'] = 'Räume verwalten';
...
$string['clash'] = 'Konflikt: {$a->oldbooking} {$a->newbooking} {$a->time} mit Raum: {$a->room}';
$string['clashemailbody'] = 'Während des aktuellen Imports gab es einen Konflikt bei der Buchuung: Um {$a->time} benutzen {$a->oldbooking} und {$a->newbooking} beide gleichzeitig den Raum {$a->room}. Korrigieren Sie das Problem, um unnötige Störungen zu vermeiden. DIES IST DIE EINZIGE WARNUNG DIESES KONFLIKTS. WENN SIE DIESE E-MAIL IGNORIEREN KANN ES ZU PROBLEMEN KOMMEN. Die Mail wurde automatisch vom Buchungssystem versendet. Wenn Sie denken, dass  hier ein Fehler vorliegt, kontaktieren Sie den Administrator {$a->admin}';
...
$string['config_default_room'] = 'Standard Raum';
$string['config_default_room2'] = 'Standardmäßig wird dieser Raum beim Aufruf des Buchungssystems gezeigt. Die Raum- bzw. Gerätennummer lässt sich über den Link auf den Raum herausfinden.';
...
$string['config_mail_room_admin_on_bookings'] = 'E-Mail an Raumadmin';
$string['config_mail_room_admin_on_bookings2'] = 'Der Raumadmin wird per E-Mail über neue Buchungen seiner Räume informiert.';
...
$string['days'] = 'Tage';
$string['delarea'] = 'Sie müssen alle Räume im Bereich löschen, bevor Sie den Bereich löschen können<p>';
...
$string['mrbs_rlp:administermrbs_rlp'] = 'Zugriff MRBS (lesen / schreiben / admin)';
$string['mrbs_rlp:editmrbs_rlp'] = 'Zugriff MRBS (lesen / schreiben)';
$string['mrbs_rlp:doublebook'] = 'Doppelbuchungen vornehmen';
$string['mrbs_rlp:editmrbs_rlpunconfirmed'] = 'Only create \'unconfirmed\' bookings (overriden by \'editmrbs_rlp\')';
...
$string['mrbs_rlp:viewmrbs_rlp'] = 'Zugriff MRBS (nur lesen)';
...
$string['noroomsfound'] = 'Keine Räume gefunden';
...
$string['notallowedbook'] = 'Sie stehen nicht in der Liste der Personen, die diesen Raum buchen dürfen.';
$string['of'] = ' von ';
...
$string['requestvacate'] = 'Anfrage ob diese Raum umgebucht werden kann';
...
$string['room_admin_email'] = 'E-Mail Raumadmin';
$string['room'] = 'Raum';
$string['roomchange'] = 'Als Änderung markieren';
$string['rooms'] = 'Räume';
$string['roomsearch'] = 'Raum suchen';
$string['roomsfree'] = 'Raum frei...';
...
$string['update_room_failed'] = 'Raumänderung fehlgeschlagen: ';
$string['useful_n-weekly_value'] = 'sinnvollen Wert für n-wöchentlich';
$string['valid_room'] = 'Raum.';
...
$string['you_have_not_selected'] = 'Sie haben keine Räume ';
