...
// $Id: block_mrbs_rlp.php,v 1.6 2008/12/03 17:23:16 arborrow Exp $
$string['about_mrbs_rlp'] = 'Acerca de MRBS';
$string['accessdenied'] = 'Acceso denegado';
$string['accessmrbs_rlp'] = 'Reservar locales o recursos';
...
$string['mrbs_rlp:administermrbs_rlp'] = 'Acceso MRBS (Lectura / Escritura / Administración)';
$string['mrbs_rlp:editmrbs_rlp'] = 'Acceso MRBS (Lectura / Escritura)';
$string['mrbs_rlp:viewmrbs_rlp'] = 'Acceso MRBS (Lectura)';
$string['mrbs_rlp'] = 'Gestor de Reserva de Salas';
