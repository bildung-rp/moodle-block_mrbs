...
$string['mrbs_rlp:administermrbs'] = 'Acceso MRBS (Lectura / Escritura / Administración)';
$string['mrbs_rlp:editmrbs'] = 'Acceso MRBS (Lectura / Escritura)';
$string['mrbs_rlp:viewmrbs'] = 'Acceso MRBS (Lectura)';
