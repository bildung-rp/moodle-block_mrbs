...
$settings->add(new admin_setting_configtext('serverpath', get_string('serverpath', 'block_mrbs'), get_string('adminview', 'block_mrbs'), $CFG->wwwroot . '/blocks/mrbs/web', PARAM_URL));
