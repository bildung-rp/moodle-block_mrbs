...
$mrbs_rlp_company = $SITE->fullname;
$mrbs_rlp_company_url = $CFG->wwwroot;
...
# notification.
$url_base = $cfg_mrbs_rlp->serverpath;
...
<<<<<<< HEAD
    ...
    $morningstarts = $cfg_mrbs_rlp->morningstarts;
    $eveningends = $cfg_mrbs_rlp->eveningends;
    ...
    $morningstarts_minutes = $cfg_mrbs_rlp->morningstarts_min;
...
$weekstarts = $cfg_mrbs_rlp->weekstarts;

# Trailer date format: 0 to show dates as "Jul 10", 1 for "10 Jul"
$dateformat = $cfg_mrbs_rlp->dateformat;

# Time format in pages. 0 to show dates in 12 hour format, 1 to show them
# in 24 hour format
$twentyfourhour_format = $cfg_mrbs_rlp->timeformat;

########################
# Miscellaneous settings
########################
# Maximum repeating entrys (max needed +1):
$max_rep_entrys = $cfg_mrbs_rlp->max_rep_entrys + 1;

# Max advance days for booking
$max_advance_days = isset($cfg_mrbs_rlp->max_advance_days) ? $cfg_mrbs_rlp->max_advance_days : -1;

# Default report span in days:
$default_report_days = $cfg_mrbs_rlp->default_report_days;
...
# of 12.
$monthly_view_entries_details = $cfg_mrbs_rlp->monthly_view_entries_details;

# To view weeks in the bottom (trailer.php) as week numbers (42) instead of
# 'first day of the week' (13 Oct), set this to TRUE
$view_week_number = $cfg_mrbs_rlp->view_week_number;
...
# Default is 0
$default_room = $cfg_mrbs_rlp->default_room;
...
define("MAIL_AREA_ADMIN_ON_BOOKINGS", $cfg_mrbs_rlp->mail_area_admin_on_bookings);
...
$mail["subject"] = get_string('mail_subject', 'block_mrbs_rlp', $mrbs_rlp_company);

# Set the content of the Subject field for deleted fields.
$mail["subject_delete"] = get_string('mail_subject_delete', 'block_mrbs_rlp', $mrbs_rlp_company);
...
# here will be added at the top of the message body.
$mail["changed_entry"] = get_string('mail_changed_entry', 'block_mrbs_rlp');
...
# Each type has a color (see TD.x classes in the style sheet mrbs_rlp.css).
...
$typel["A"] = $cfg_mrbs_rlp->entry_type_a;
$typel["B"] = $cfg_mrbs_rlp->entry_type_b;
$typel["C"] = $cfg_mrbs_rlp->entry_type_c;
$typel["D"] = $cfg_mrbs_rlp->entry_type_d;
$typel["E"] = $cfg_mrbs_rlp->entry_type_e;
$typel["F"] = $cfg_mrbs_rlp->entry_type_f;
$typel["G"] = $cfg_mrbs_rlp->entry_type_g;
$typel["H"] = $cfg_mrbs_rlp->entry_type_h;
$typel["I"] = $cfg_mrbs_rlp->entry_type_i;
