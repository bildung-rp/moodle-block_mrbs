...
if ($record = $DB->get_record('block_mrbs_rlp_entry', ['id' => $id])) {
    if (strtolower($record->create_by) == strtolower($USER->username)) {
        ...
        if ($redirect) {
            redirect(new moodle_url('/blocks/mrbs_rlp/web/edit_entry.php', ['id' => $id]));
        }
    }
}
...
$thisurl = new moodle_url('/blocks/mrbs_rlp/web/view_entry.php', ['day' => $day, 'month' => $month, 'year' => $year, 'id' => $id]);
...
if ($series == 1) {
    ...
    $entry = $DB->get_records('block_mrbs_rlp_entry', ['repeat_id' => $id, 'entry_type' => 1], 'start_time', 'id', 0, 1);
    if (empty($entry)) {
        ...
        $entry = $DB->get_records('block_mrbs_rlp_entry', ['repeat_id' => $id], 'start_time', 'id', 0, 1);
    }
...
<<<<<<< HEAD
    ...
    <tr>
        <td><b><?php echo get_string('start_date', 'block_mrbs_rlp') ?></b></td>
        <td><?php echo $start_date ?></td>
    </tr>
    <tr>
        <td><b><?php echo get_string('duration', 'block_mrbs_rlp') ?></b></td>
        <td><?php echo $duration . " " . $dur_units ?></td>
    </tr>
    <tr>
        <td><b><?php echo get_string('end_date', 'block_mrbs_rlp') ?></b></td>
        <td><?php echo $end_date ?></td>
    </tr>
    <tr>
        <td><b><?php echo get_string('type', 'block_mrbs_rlp') ?></b></td>
